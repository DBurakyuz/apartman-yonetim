...
mixin _$AppUser {
  ...
  String? get apartmentId =>
      throw _privateConstructorUsedError; // Hangi site/apartmanda olduğu (Admin için boş olabilir)
...
class _$AppUserImpl implements _AppUser {
  ...
  // Hangi site/apartmanda olduğu (Admin için boş olabilir)
  @override
  final String? flatNumber;

  @override
  String toString() {
    return 'AppUser(id: $id, email: $email, name: $name, role: $role, apartmentId: $apartmentId, flatNumber: $flatNumber)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, email, name, role, apartmentId, flatNumber);
...
abstract class _AppUser implements AppUser {
  ...
  UserRole get role;
  @override
  String? get apartmentId; // Hangi site/apartmanda olduğu (Admin için boş olabilir)
  @override
